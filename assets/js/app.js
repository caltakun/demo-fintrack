...
const performLogout=()=>{clearAuthenticated();localStorage.removeItem(CURRENT_USER_KEY);setSidebarOpen(false);showLogin();setAuthMode("login");resetLoginForm();setTimeout(()=>loginEmail?.focus(),0)};
if(logoutBtn)logoutBtn.onclick=performLogout;
const sidebarLogoutBtn=document.getElementById("sidebarLogoutBtn");
if(sidebarLogoutBtn)sidebarLogoutBtn.onclick=performLogout;
